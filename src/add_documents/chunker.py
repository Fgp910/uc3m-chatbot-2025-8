...
class SGIAChunker:
    ...
    def __init__(self, extraction_results_path: Path = None):
        """
        ...
        """
        # Always define it, even if empty
        self.extraction_metadata = {}

        # If you have an extraction_results.json, load it
        if extraction_results_path:
